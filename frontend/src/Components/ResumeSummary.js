...
export default function SummaryStep({ onNext, onPrev }) {
  ...
  // ✅ Resume props depending on template
  ...
  return (
    <Box display="flex" minHeight="100vh">
      ...
      >
        ...
        {/* Change Template Link - Hidden on small mobile */}
        {!isSmallMobile && (
          <Typography
            variant="body2"
            sx={{
