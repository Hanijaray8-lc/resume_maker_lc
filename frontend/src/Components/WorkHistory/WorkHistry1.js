      ...
      >
        ...
        <Box
          sx={{
            ...
            display: "flex",
            gap: 3,
            flexDirection: isMobile ? "row" : "row", // Always row for both
            alignItems: "center",
            justifyContent: isMobile ? "space-between" : "center", // Space between for mobile, center for desktop
            width: "100%",
            maxWidth: isMobile ? "100%" : "400px", // Limit width on desktop
            margin: isMobile ? "0" : "0 auto", // Center the container on desktop
          }}
        >
          <Button 
            variant="outlined" 
            sx={{ 
              ...
              fontWeight: "bold", 
              height: 45,
              width: isMobile ? "48%" : "auto", // 48% width on mobile for equal spacing
