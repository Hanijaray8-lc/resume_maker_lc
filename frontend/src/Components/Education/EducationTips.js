  ...
  return (
    <Box display="flex" minHeight="100vh">
      ...
      >
        ...
        >
          Let's get started with your Education.
        </Typography>
        ...
        >
          ...
          <br />
          Hiring managers glance over the education section quickly.
          <br />
          We'll ensure the formatting keeps it clear and noticeable.
        </Typography>
        ...
        {/* Navigation Buttons - Always in one line */}
        <Box 
          display="flex" 
          ...
          alignItems="center"
          sx={{
            flexWrap: isSmallMobile ? "wrap" : "nowrap", // Wrap only on very small screens if needed
          }}
        >
          <Button 
            variant="outlined" 
            sx={{ 
              px: isSmallMobile ? 2 : 5, 
              borderRadius: 3,
              width: isSmallMobile ? "45%" : "auto", // 45% width on small mobile
          ...
          <Button
            ...
            onClick={() => navigate("/EducationSection", { 
              state: { 
                selectedTemplate, 
                selectedTheme 
              } 
